...
\usetikzlibrary{shapes,decorations,arrows,calc,arrows.meta,fit,positioning,decorations.fractals}
\tikzset{
    -Latex,auto,node distance =1 cm and 1 cm,semithick,
    state/.style ={ellipse, draw, minimum width = 0.7 cm},
    point/.style = {circle, draw, inner sep=0.01cm,fill,node contents={}},
...
\definecolor{pennred}{HTML}{FFCC33}
\definecolor{pennblue}{HTML}{7A0019}
...
\includegraphics[width=4cm,height=4cm,keepaspectratio]{figures/logoumn.png} 
\hfill
\includegraphics[width=2cm,height=2cm,keepaspectratio]{figures/mpc_logo.png}
}\vspace{-1.2cm}
...
\institute[shortinst]{\textsuperscript{} University of Minnesota, Department of Sociology}
